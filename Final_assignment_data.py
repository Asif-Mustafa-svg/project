...
# Display the downloaded data and reset index
...
#Getting_URL_and_requests
url ="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-PY0220EN-SkillsNetwork/labs/project/revenue.htm"
html_data = requests.get(url).text
#Application_of_beautifulsoup
soup = BeautifulSoup(html_data, 'html5lib')
#Loop_and_getting_the_column_row_data_and_creating_dataframe_to_put_values
...
#replacing-unnecessary_signs_and_dropping_null_values     
...
#printing_tail_values_of_gme_revenue
